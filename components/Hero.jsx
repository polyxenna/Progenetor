...
const Hero = () => {
  ...
  const handleGenerateOutput = async () => {
    ...
    try {
      ...
      const chatSession = model.startChat({
        ...
        history: [
          ...
          },
          {
            role: "user",
            parts: [
              { text: "Give me a ChatGPT prompt to generate review questions" },
            ],
          },
          {
            role: "model",
      ...
      setOutput(markdownToHtml(result.response.text()));
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 flex items-center justify-center overflow-hidden pt-[80px] pb-16 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[150px] 2xl:pb-[200px]"
      >
                  ...
                  <>
                    <div className="mb-6">
                      ...
                      <button
                        ...
                        className="mt-4 rounded-md bg-primary py-4 px-8 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                      >
                        Generate
                      </button>
                    </div>
                    <div className="mx-auto mt-6 max-w-[800px] p-4 border rounded-md">
